...
class App(tk.Tk):
    def __init__(self):
        ...
        self.paned_window.add(self.left_panel, width=int(self.winfo_screenwidth() * 0.75))
        ...
        self.connection_status_label = tk.Label(self.left_panel, text="Checking...", font=("Arial", 12), bg="#f0f0f0")
        ...
        self.pc_name_button = tk.Button(self.pc_name_frame, text="Change PC Name", command=self.change_pc_name, font=("Arial", 10), bg="#FFFFFF", fg="black")
        ...
        self.exit_button = tk.Button(self, text="Exit", command=self.destroy, font=("Arial", 10), bg="#ffffff", fg="black", activebackground="#e60000")
    ...
    def load_logo(self):
        ...
        try:
            ...
            if width > 200 or height > 200:
                logo_img = logo_img.resize((700, 350), Image.LANCZOS)
